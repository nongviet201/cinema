                ...
                for (Cinema cinema : cinemas) {
                    ...
                    for (Auditorium aud : auditoriums) {
                        ...
                        for (int j = 0; j <= numShowtime[random.nextInt(numShowtime.length)]; j++) {
                            ...
                            if (types.size() == 2) {
                                GraphicsType graphicsType = types.get(numShowtime[random.nextInt(numShowtime.length)] - 1);
                            // Lưu suất chiếu
