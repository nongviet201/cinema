...
class CinemaApplicationTests {
    ...
    @Test
    void createPost() {
        User admin = userRepository.save(new User(1, "admin", "admin@admin.com", "12345678", "Avatar", "0123456789", "Nam", LocalDate.of(1990, 1, 1), UserRole.ADMIN, true, LocalDate.now(), LocalDate.now()));
